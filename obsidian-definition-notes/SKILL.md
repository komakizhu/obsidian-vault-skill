...
这是一个可独立调用的 Obsidian 子 skill。完整工作规范见 [Definition Notes](../obsidian-knowledge-manager/references/definition-notes.md)，本文件负责触发和路由。
...
1. 读取并执行 `/Users/mac/.codex/skills/obsidian-knowledge-manager/SKILL.md` 的 vault 检测流程。
